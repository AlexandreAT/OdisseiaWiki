...
namespace OdisseiaWiki.Migrations
{
    ...
    [Migration("20260926193709_AddGameplayEffectApplications")]
    partial class AddGameplayEffectApplications
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OdisseiaWiki.Models.Mesa", b =>
                {
                    ...
                    b.Property<long?>("IdMesaSessaoAtiva")
                        .HasColumnType("bigint")
                        .HasColumnName("IDMesaSessaoAtiva");
            ...
            modelBuilder.Entity("OdisseiaWiki.Models.MesaComando", b =>
                {
                    b.Property<long>("IdMesaComando")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                        .HasColumnName("IDMesaComando");

                    MySqlPropertyBuilderExtensions.UseMySqlIdentityColumn(b.Property<long>("IdMesaComando"));
                    ...
                    b.Property<int?>("IdUsuarioAtor")
                        .HasColumnType("int(11)")
                        .HasColumnName("IDUsuarioAtor");

                    b.Property<string>("RespostaJson")
                        .IsRequired()
                        .HasColumnType("json");

                    b.Property<long?>("RevisaoMesaEsperada")
                        .HasColumnType("bigint");

                    b.Property<long?>("RevisaoPersonagemEsperada")
                        .HasColumnType("bigint");

                    b.Property<long?>("RevisaoSessaoEsperada")
                        .HasColumnType("bigint");

                    b.Property<string>("RevisoesAlvosJson")
                        .HasColumnType("json");
                    ...
                    b.HasKey("IdMesaComando");

                    b.HasIndex("IdPersonagemJogador");

                    b.HasIndex("IdUsuarioAtor");

                    b.HasIndex("IdMesaSessao", "CriadoEmUtc")
                        .HasDatabaseName("IX_MesaComando_Sessao_Data");

                    b.HasIndex("IdMesa", "IdUsuarioAtor", "ChaveIdempotencia")
                        .IsUnique()
            ...
            modelBuilder.Entity("OdisseiaWiki.Models.MesaEvento", b =>
                {
                    b.Property<long>("IdMesaEvento")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                        .HasColumnName("IDMesaEvento");

                    MySqlPropertyBuilderExtensions.UseMySqlIdentityColumn(b.Property<long>("IdMesaEvento"));
                    ...
                    b.Property<int?>("IdSistemaVersaoEfetiva")
                        .HasColumnType("int")
                        .HasColumnName("IDSistemaVersaoEfetiva");

                    b.Property<int?>("IdSistemaVersaoPersonagem")
                        .HasColumnType("int")
                        .HasColumnName("IDSistemaVersaoPersonagem");
                    ...
                    b.HasKey("IdMesaEvento");

                    b.HasIndex("IdMesaComando");

                    b.HasIndex("IdSistemaRpg");

                    b.HasIndex("IdSistemaVersaoEfetiva");

                    b.HasIndex("IdSistemaVersaoPersonagem");

                    b.HasIndex("IdUsuarioAtor");

                    b.HasIndex("IdMesaSessao", "OcorreuEmUtc")
                        .HasDatabaseName("IX_MesaEvento_Sessao_Data");

                    b.HasIndex("IdMesaSessao", "Sequencia")
                        .IsUnique()
                        .HasDatabaseName("UX_MesaEvento_Sessao_Sequencia");

                    b.HasIndex("IdPersonagemJogador", "OcorreuEmUtc")
                        .HasDatabaseName("IX_MesaEvento_Personagem_Data");

                    b.HasIndex("Tipo", "CodigoRegra")
                        .HasDatabaseName("IX_MesaEvento_Tipo_Regra");

                    b.ToTable("mesaeventos", (string)null);
                });
            ...
            modelBuilder.Entity("OdisseiaWiki.Models.MesaRolagem", b =>
                {
                    b.Property<long>("IdMesaEvento")
                        .HasColumnType("bigint")
                        .HasColumnName("IDMesaEvento");
                    ...
                    b.Property<string>("ModificadoresJson")
                        .IsRequired()
                        .HasColumnType("json");
                    ...
                    b.Property<int?>("ValorAssociado")
                        .HasColumnType("int");

                    b.Property<int?>("ValorNatural")
                        .HasColumnType("int");

                    b.HasKey("IdMesaEvento");

                    b.ToTable("mesarolagens", (string)null);
                });
            ...
            modelBuilder.Entity("OdisseiaWiki.Models.MesaSessao", b =>
                {
                    ...
                    MySqlPropertyBuilderExtensions.UseMySqlIdentityColumn(b.Property<long>("IdMesaSessao"));

                    b.Property<int?>("ChaveAtiva")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("int")
                        .HasComputedColumnSql("CASE WHEN `Status` = 'Ativa' THEN 1 ELSE NULL END", true);

                    b.Property<string>("ContextoAberturaJson")
                        .HasColumnType("json");

                    b.Property<DateTime?>("EncerradaEmUtc")
                        .HasColumnType("datetime(6)");
                    ...
                    b.Property<int?>("IdUsuarioEncerramento")
                        .HasColumnType("int(11)")
                        .HasColumnName("IDUsuarioEncerramento");
                    ...
                    b.Property<long>("UltimaSequenciaEvento")
                        .HasColumnType("bigint");

                    b.Property<int>("VersaoSchema")
                        .HasColumnType("int");

                    b.HasKey("IdMesaSessao");

                    b.HasIndex("IdSistemaVersao");

                    b.HasIndex("IdUsuarioCriacao");

                    b.HasIndex("IdUsuarioEncerramento");

                    b.HasIndex("IdMesa", "ChaveAtiva")
                        .IsUnique()
                        .HasDatabaseName("UX_MesaSessao_Mesa_Ativa");

                    b.HasIndex("IdMesa", "Status", "IniciadaEmUtc")
                        .HasDatabaseName("IX_MesaSessao_Mesa_Status_Inicio");

                    b.ToTable("mesasessoes", (string)null);
                });
            ...
            modelBuilder.Entity("OdisseiaWiki.Models.PersonagemVisibilidade", b =>
                {
                    b.Property<int>("IdpersonagemVisibilidade")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int(11)")
                        .HasColumnName("IDPersonagemVisibilidade");

                    MySqlPropertyBuilderExtensions.UseMySqlIdentityColumn(b.Property<int>("IdpersonagemVisibilidade"));

                    b.Property<bool>("Alinhamento")
                        .HasColumnType("tinyint(1)");

                    b.Property<bool>("AtributosPrincipais")
                        .HasColumnType("tinyint(1)");

                    b.Property<bool>("AtributosSecundarios")
                        .HasColumnType("tinyint(1)");

                    b.Property<bool>("CapacidadeCarga")
                        .HasColumnType("tinyint(1)");

                    b.Property<bool>("Cidade")
                        .HasColumnType("tinyint(1)");
                    ...
                    b.Property<bool>("Defesas")
                        .HasColumnType("tinyint(1)");

                    b.Property<bool>("Estamina")
                        .HasColumnType("tinyint(1)");

                    b.Property<bool>("Galeria")
                        .HasColumnType("tinyint(1)");
                    ...
                    b.Property<bool>("Imagem")
                        .HasColumnType("tinyint(1)");

                    b.Property<bool>("Inventario")
                        .HasColumnType("tinyint(1)");

                    b.Property<bool>("Magias")
                        .HasColumnType("tinyint(1)");

                    b.Property<bool>("Mana")
                        .HasColumnType("tinyint(1)");

                    b.Property<bool>("Nivel")
                        .HasColumnType("tinyint(1)");

                    b.Property<bool>("Nome")
                        .HasColumnType("tinyint(1)");

                    b.Property<bool>("Passivas")
                        .HasColumnType("tinyint(1)");

                    b.Property<bool>("PersonagensRelacionados")
                        .HasColumnType("tinyint(1)");

                    b.Property<bool>("Proteses")
                        .HasColumnType("tinyint(1)");
                    ...
                    b.Property<bool>("TracosPersonalidade")
                        .HasColumnType("tinyint(1)");
                    ...
                    b.HasKey("IdpersonagemVisibilidade")
                        .HasName("PRIMARY");
                    ...
                    b.ToTable("personagensvisibilidade", null, t =>
                        {
                            t.HasCheckConstraint("CK_PersonagemVisibilidade_Alvo", "(`IDPersonagem` IS NOT NULL AND `IDPersonagemJogador` IS NULL) OR (`IDPersonagem` IS NULL AND `IDPersonagemJogador` IS NOT NULL)");
                        });
                });
            ...
            modelBuilder.Entity("OdisseiaWiki.Models.UsuarioEmailToken", b =>
                {
                    b.Property<int>("IdusuarioEmailToken")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int(11)")
                        .HasColumnName("IDUsuarioEmailToken");

                    MySqlPropertyBuilderExtensions.UseMySqlIdentityColumn(b.Property<int>("IdusuarioEmailToken"));
                    ...
                    b.HasIndex("Idusuario", "Tipo", "DataUso", "DataInvalidacao")
            ...
            modelBuilder.Entity("OdisseiaWiki.Models.Mesa", b =>
                {
                    b.HasOne("OdisseiaWiki.Models.MesaSessao", "SessaoAtiva")
                        .WithMany()
                        .HasForeignKey("IdMesaSessaoAtiva")
                        .OnDelete(DeleteBehavior.Restrict)
            ...
            modelBuilder.Entity("OdisseiaWiki.Models.MesaComando", b =>
                {
                    ...
                    b.HasOne("OdisseiaWiki.Models.Usuario", "UsuarioAtor")
                        .WithMany()
                        .HasForeignKey("IdUsuarioAtor")
                        .OnDelete(DeleteBehavior.SetNull)
            ...
            modelBuilder.Entity("OdisseiaWiki.Models.MesaEvento", b =>
                {
                    b.HasOne("OdisseiaWiki.Models.MesaComando", "Comando")
                        .WithMany("Eventos")
                        .HasForeignKey("IdMesaComando")
                        .OnDelete(DeleteBehavior.SetNull)
                    ...
                    b.HasOne("OdisseiaWiki.Models.SistemaVersao", "SistemaVersaoEfetiva")
                        .WithMany()
                        .HasForeignKey("IdSistemaVersaoEfetiva")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("FK_MesaEvento_SistemaVersaoEfetiva");

                    b.HasOne("OdisseiaWiki.Models.SistemaVersao", "SistemaVersaoPersonagem")
                        .WithMany()
                        .HasForeignKey("IdSistemaVersaoPersonagem")
                        .OnDelete(DeleteBehavior.Restrict)
                    ...
                    b.Navigation("SistemaVersaoEfetiva");

                    b.Navigation("SistemaVersaoPersonagem");
            ...
            modelBuilder.Entity("OdisseiaWiki.Models.MesaRolagem", b =>
                {
                    b.HasOne("OdisseiaWiki.Models.MesaEvento", "Evento")
                        .WithOne("Rolagem")
                        .HasForeignKey("OdisseiaWiki.Models.MesaRolagem", "IdMesaEvento")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("OdisseiaWiki.Models.MesaSessao", b =>
                {
                    ...
                    b.HasOne("OdisseiaWiki.Models.Usuario", "UsuarioCriacao")
                        .WithMany()
                        .HasForeignKey("IdUsuarioCriacao")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("FK_MesaSessao_UsuarioCriacao");

                    b.HasOne("OdisseiaWiki.Models.Usuario", "UsuarioEncerramento")
                        .WithMany()
                        .HasForeignKey("IdUsuarioEncerramento")
                        .OnDelete(DeleteBehavior.SetNull)
                    ...
                    b.Navigation("UsuarioEncerramento");
                });
            ...
            modelBuilder.Entity("OdisseiaWiki.Models.PersonagemVisibilidade", b =>
                {
                    b.HasOne("OdisseiaWiki.Models.Personagen", "Personagem")
                        .WithOne("ConfiguracaoVisibilidade")
                        .HasForeignKey("OdisseiaWiki.Models.PersonagemVisibilidade", "Idpersonagem")
                        .OnDelete(DeleteBehavior.Cascade)
                        .HasConstraintName("FK_PersonagemVisibilidade_Personagem");

                    b.HasOne("OdisseiaWiki.Models.PersonagemJogador", "PersonagemJogador")
                        .WithOne("ConfiguracaoVisibilidade")
                        .HasForeignKey("OdisseiaWiki.Models.PersonagemVisibilidade", "IdpersonagemJogador")
                        .OnDelete(DeleteBehavior.Cascade)
            ...
            modelBuilder.Entity("OdisseiaWiki.Models.PersonagemJogador", b =>
                {
                    b.Navigation("ConfiguracaoVisibilidade");
